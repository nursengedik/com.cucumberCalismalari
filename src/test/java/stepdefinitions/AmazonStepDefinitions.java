...
public class AmazonStepDefinitions {
    AmazonPage amazonPage = new AmazonPage();//amazonPage objesi method içinde oluşturulunca başka methodlar
                                            //tarafından kullanılamaz, bu nedenle class level'da oluşturulur
    ...
    public void nutella_icin_arama_yapar() {                               //AmazonPage'de olan
        amazonPage.aramaKutusu.sendKeys("Nutella" + Keys.ENTER);//arama kutusunun locate alınıp
    }                                                                     //nutella yazdırılır
    ...
    public void java_icin_arama_yapar() {
        amazonPage.aramaKutusu.sendKeys("Java" + Keys.ENTER);//arama kutusu locate edilip java
    }                                                                  //yazdırılır
    ...
    public void icinAramaYapar(String aranacakKelime) {
        ...
        amazonPage.aramaKutusu.sendKeys(aranacakKelime + Keys.ENTER);//nutella, java, samsung
    }
